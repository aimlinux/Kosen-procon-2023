...
while i < shoku:
    ...
    if a[0][y][x] == 0:
        ...
        i += 1
# 池を配置
ike_x = [1,1,1,1,2,3,3,4,4,5,5,5,6,6,7,7,8,9,9,9,9]
ike_y = [1,4,6,9,5,3,7,1,9,2,5,8,1,9,3,7,5,1,4,6,9]
i = 0
ik = [[0, 0]]*ike
while i < ike:
    x = ike_x[i]
    ...
    if a[0][y][x] == 0:
        ...
        i += 1
# 城を配置
si_x = [2,2,4,4,6,6,8,8]
si_y = [2,8,4,6,4,6,2,8]
i = 0
si = [[0, 0]]*siro
while i < siro:
    x = si_x[i]
