...
while i < shoku:
    ...
    if a[0][y][x] == 0:
        ...
        i += 1
# 池を配置
ike_x = [0,0,1,2,2,2,2,3,3,4,4,4,4,5,5,6,6,6,6,7,7,8,8,8,8,9,10,10]
ike_y = [9,10,9,5,6,7,8,4,5,3,4,6,7,3,7,3,4,6,7,5,6,2,3,4,5,1,0,1]
i = 0
ik = [[0, 0]]*ike
while i < ike:
    x = ike_x[i]
    ...
    if a[0][y][x] == 0:
        ...
        i += 1
# 城を配置
si_x = [1,1,2,3,4,5,5,5,6,7,8,9,9]
si_y = [7,8,9,7,5,4,5,6,5,3,1,2,3]
i = 0
si = [[0, 0]]*siro
while i < siro:
    x = si_x[i]
